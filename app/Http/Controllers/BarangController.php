...
class BarangController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.barang', compact('kategori', 'data', 'subkategori'));
    }
    ...
    public function store(Request $request)
    {
                ...
                if (is_null($cek)) {
                    if ($request->hasFile('foto')) {
                        ...
                        foreach ($image as $files) {
                            ...
                            $fotoinput->idbarang     =   $request->idedit;
                            $fotoinput->foto         =   $file;
                            $fotoinput->save();
        ...
        } elseif ($request->hasFile('foto') == '' && $request->hasFile('fotoutama')) {
            $file               =   $request->file('fotoutama');
            $id                 =   date('Ymd');
            $filefile           =   $id . '' .  str_replace(" ", "_", $file->getClientOriginalName());
    ...
    {
        return StockBarang::find($request->id);
    }
