        ...
        uglify: {
          my_target: {
            files: {
                ...
                'assets/bundles/fullcalendarscripts.bundle.js': ['../assets/vendor/fullcalendar/moment.min.js'],
                'assets/bundles/jvectormap.bundle.js': ['../assets/vendor/jvectormap/jquery-jvectormap-2.0.3.min.js','../assets/vendor/jvectormap/jquery-jvectormap-world-mill-en.js'],   /* calender page js */
